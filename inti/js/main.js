...
function documentReadyInit() {
	...
	if ($().countdown) {
		...
		if(date) {
			...
			var countDownDate = new Date("Aug 17, 2020 00:00:00").getTime();
	...
	var countDownDate = new Date("Aug 17, 2020 00:00:00").getTime();
		var x = setInterval(function() {
		  ...
		  document.getElementById("comingsoon-countdown").innerHTML = days + "d " + hours + "h "
		  + minutes + "m " + seconds + "s ";
		    
		  if (distance < 0) {
		    clearInterval(x);
		    document.getElementById("comingsoon-countdown").innerHTML = "";
		  }
		}, 1000);
